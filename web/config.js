...
config.hosts = {};
config.hosts.domain = 'video.onesolutions.net';
...
config.hosts.muc = 'muc.' + subdomain + 'video.onesolutions.net';
config.bosh = 'https://video.onesolutions.net/' + subdir + 'http-bind';
config.websocket = 'wss://video.onesolutions.net/' + subdir + 'xmpp-websocket';
